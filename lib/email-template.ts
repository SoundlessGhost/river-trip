...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      ${
        data.culturalInterest.length > 0
          ? `
      <div class="field">
        <span class="label">সাংস্কৃতিক আগ্রহ:</span>
        <span class="value">${data.culturalInterest.join(", ")}</span>
      </div>
      `
          : ""
      }
      ...
      ${
        data.sportsInterest
          ? `
      <div class="field">
        <span class="label">খেলায় আগ্রহী:</span>
        <span class="value">${data.sportsInterest}</span>
      </div>
      `
          : ""
      }
      ...
      ${
        data.contributionAgreement
          ? `
      <div class="field">
        <span class="label">টাকা প্রদানে সম্মত:</span>
        <span class="value">${data.contributionAgreement}</span>
      </div>
      `
          : ""
      }
      ...
      ${
        data.sponsorshipAgreement
          ? `
      <div class="field">
        <span class="label">স্পন্সর/অনুদান:</span>
        <span class="value">${data.sponsorshipAgreement}</span>
      </div>
      `
          : ""
      }
      ...
      ${
        data.volunteerInterest
          ? `
      <div class="field">
        <span class="label">স্বেচ্ছাসেবক হতে আগ্রহী:</span>
        <span class="value">${data.volunteerInterest}</span>
      </div>
      `
          : ""
      }
      ...
      ${
        data.comments
          ? `
      <div class="field">
        <span class="label">মতামত/প্রত্যাশা:</span>
...
//       <div class="amount-box">
//         <div class="label">TOTAL AMOUNT RECEIVED</div>
//         <div class="amount">${data.received_amount} ${data.currency}</div>
//       </div>
...
//       <div class="field">
//         <span class="label">Customer Order ID:</span>
//         <span class="value">${data.customer_order_id}</span>
//       </div>

//       <div class="field">
//         <span class="label">Bank Transaction ID:</span>
//         <span class="value">${data.bank_trx_id}</span>
//       </div>

//       <div class="field">
//         <span class="label">Payment Status:</span>
//         <span class="value">${data.bank_status}</span>
//       </div>
...
//       <div class="field">
//         <span class="label">Address:</span>
//         <span class="value">${data.address}, ${data.city}</span>
//       </div>
...
//         <div class="field">
//           <span class="label">Received:</span>
//           <span class="value">${data.received_amount} ${data.currency}</span>
//         </div>
//       </div>
